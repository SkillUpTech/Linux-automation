	...
	public void startTesting()
	{
		...
		finally
		{
			...
			if(driver.getCurrentUrl().contains("stage"))
			{
				...
				ProcessExcel.writeExcelFileAsRows(EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP, "/var/lib/jenkins/jobs/Stage Automation/test-output/", "stage_result_" + formattedDateTime + ".xlsx");
			}
