...
public class EditProfileValidation implements Callable<String>
{
	...
	public void verifyProfileIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(1).set(0,
					"ProfileIcon - failed");
		}
	}
	...
	public void verifyUpdateIcon() throws InterruptedException {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(2).set(0,
					"contacts_updateIcon - failed");
		}
	...
	public void verifySubmitWithoutDataForMobile() throws InterruptedException {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(3).set(0,
					"contacts_submitWithoutData - failed");
		}
	}
	...
	public void verifySubmitInvalidDataForMobile(String data) throws InterruptedException {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(4).set(0,
					"contacts_submitInvalidData_mobile - failed");
		}
	}
	...
	public void verifyCancelIcon() throws InterruptedException {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(5).set(0,
					"contacts_cancelIcon - failed");
		}
	}
	...
	public void verifyContactsAlertClose() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(6).set(0,
					"contacts_Alert_close - failed");
		}
	}
	...
	public void verifySubmitValidDataForMobile(String data) throws InterruptedException {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(7).set(0,
					"contacts_submitValidData_mobile - failed");
		}
	}
	...
	public void verifyAlertYesButton() throws InterruptedException {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(8).set(0,
					"contacts_Alert_yesButton - failed");
		}
	}
	...
	public void verifyAlertGoBackButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(9).set(0,
					"contacts_Alert_goBackButton - failed");
		}
	}
	...
	public void verifyAreasOfInterestUpdateIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(10).set(0,
					"AreasOfInterest_updateIcon - failed");
		}
	}
	...
	public void verifyAreasOfInterestCancelIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(11).set(0,
					"contacts_Alert_goBackButton - failed");
		}
	}
	...
	public void verifyAreasOfInterestAlertClose() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(12).set(0,
					"contacts_Alert_goBackButton - failed");
		}
	}
	...
	public void verifyAreasOfInterestSubmitValidData(ArrayList<String> data) {
		...
		for (int i = 0; i < getStatus.size(); i++) {
			if (!data.contains(getStatus.get(i))) {
				...
				sheetStatus = "Fail";
				String cellValue = RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(13)
						.get(position);
				RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(13).set(position,
						(cellValue + " - failed"));
			}
		}
	}
	...
	public void verifyAreasOfInterestAlertGoBackButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(14).set(0,
					"AreasOfInterest_Alert_yesButton - failed");
		}
	}
	...
	public void verifyAreasOfInterestAlertyesButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(15).set(0,
					"AreasOfInterest_Alert_goBackButton - failed");
		}
	}
	...
	public void CurrentWorkStatus_updateIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(16).set(0,
					"CurrentWorkStatus_updateIcon - failed");
		}
	}
	...
	public void CurrentWorkStatus_cancelIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(17).set(0,
					"CurrentWorkStatus_cancelIcon - failed");
		}
	}
	...
	public void CurrentWorkStatus_Alert_close() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(18).set(0,
					"CurrentWorkStatus_Alert_close - failed");
		}
	}
	...
	public void CurrentWorkStatus_submitValidData(ArrayList<String> data) {
		...
		for (int i = 0; i < getStatus.size(); i++) {
			if (!data.contains(getStatus.get(i))) {
				int position = data.indexOf(getStatus.get(i));
				sheetStatus = "Fail";
				String cellValue = RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(19)
						.get(position);
				RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(19).set(position,
						(cellValue + " - failed"));
			}
		}
	}
	...
	public void CurrentWorkStatus_Alert_goBackButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(21).set(0,
					"CurrentWorkStatus_Alert_goBackButton - failed");
		}
	}
	...
	public void CurrentWorkStatus_Alert_yesButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(20).set(0,
					"checkCurrentWorkAlertYesButton - failed");
		}
	}
	...
	public void WorkExperience_updateIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(22).set(0,
					"WorkExperience_updateIcon - failed");
		}
	}
	...
	public void WorkExperience_cancelIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(23).set(0,
					"WorkExperience_cancelIcon - failed");
		}
	}
	...
	public void WorkExperience_Alert_close() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(24).set(0,
					"WorkExperience_Alert_close - failed");
		}
	}
	...
	public void WorkExperience_submitValidData(ArrayList<String> data) {
		...
		for (int i = 0; i < getStatus.size(); i++) {
			if (!data.contains(getStatus.get(i))) {
				int position = data.indexOf(getStatus.get(i));
				sheetStatus = "Fail";
				String cellValue = RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(25)
						.get(position);
				RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(25).set(position,
						(cellValue + " - failed"));
			}
		}
	}
	...
	public void WorkExperience_Alert_goBackButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(27).set(0,
					"WorkExperience_Alert_goBackButton - failed");
		}
	}
	...
	public void WorkExperience_Alert_yesButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(26).set(0,
					"WorkExperience_Alert_yesButton - failed");
		}
	}
	...
	public void PersonalDetails_updateIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(28).set(0,
					"PersonalDetails_updateIcon - failed");
		}
	}
	...
	public void PersonalDetails_cancelIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(29).set(0,
					"PersonalDetails_cancelIcon - failed");
		}
	}
	...
	public void PersonalDetails_Alert_close() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(30).set(0,
					"PersonalDetails_Alert_close - failed");
		}
	}
		...
		for (int i = 0; i < getStatus.size(); i++)
		{
			if (!data.contains(getStatus.get(i))) 
			{
				...
				String cellValue = RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(31)
						.get(position);
				RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(31).set(position,
						(cellValue + " - failed"));
			}
		}
	}
	...
	public void PersonalDetails_Alert_goBackButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(33).set(0,
					"PersonalDetails_Alert_goBackButton - failed");
		}
	}
	...
	public void PersonalDetails_Alert_yesButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(32).set(0,
					"PersonalDetails_Alert_yesButton - failed");
		}
	}
	...
	public void Education_updateIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(34).set(0,
					"Education_updateIcon - failed");
		}
	}
	...
	public void Education_cancelIcon() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(35).set(0,
					"Education_cancelIcon - failed");
		}
	}
	...
	public void Education_Alert_close() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(36).set(0,
					"Education_Alert_close - failed");
		}
	}
	...
	public void Education_submitValidData(ArrayList<String> data) {
		...
		for (int i = 0; i < getStatus.size(); i++) {
			if (!data.contains(getStatus.get(i))) {
				int position = data.indexOf(getStatus.get(i));
				sheetStatus = "Fail";
				String cellValue = RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(37)
						.get(position);
				RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(37).set(position,
						(cellValue + " - failed"));
			}
		}
	}
	...
	public void Education_Alert_yesButton() {
		...
		if (!getStatus.equalsIgnoreCase("pass")) {
			sheetStatus = "Fail";
			RegressionTesting.EXCEL_DATA_AS_SHEEET_NAME_AND_ROWS_MAP.get("EditProfile").get(38).set(0,
					"Education_Alert_yesButton - failed");
		}
	}
