...
public class TestCategoryPage 
{
	ITestResult result;
	WebDriverWait wait;
	CategoryPageLocators categoryPageLocators;
	...
	public TestCategoryPage(String excelPath) 
	{
		softAssert = new SoftAssert();
		categoryPageLocators = new CategoryPageLocators();
		excelPath = "C:\\Users\\Skillup 200\\Downloads\\NASSCOM INDIA PAGE (1).xlsx";
	...
	public void aboutCategoryPage(String excelPath)
	{
		...
		try {
			...
			for (Entry<String, ArrayList<ArrayList<String>>> entry : data.entrySet()) {
				...
				try {
					CategoryPageValidator categoryPageValidator = new CategoryPageValidator(sheetName, sheetData);
					String sheetStatus = categoryPageValidator.processSheetData();
