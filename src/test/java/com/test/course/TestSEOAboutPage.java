...
public class TestSEOAboutPage
{
	WebDriverWait wait;
	SEOAboutPageLocators seoAboutPageLocators;
	...
	public TestSEOAboutPage(String excelPath)
	{
		softAssert = new SoftAssert();
		seoAboutPageLocators = new SEOAboutPageLocators();
		excelPath = "C:\\Users\\Skillup 200\\Downloads\\MB-330 Microsoft Dynamics 365 Supply Chain Management.xlsx";
	...
	public void testSEOAboutPage(String excelPath)
	{
		...
		try 
		{
			...
			for (Entry<String, ArrayList<ArrayList<String>>> entry : data.entrySet()) 
			{
				...
				try
				{
					SEOAboutPageValidator seoAboutPageValidator = new SEOAboutPageValidator(sheetName, sheetData);
					String sheetStatus = seoAboutPageValidator.processSheetData();
